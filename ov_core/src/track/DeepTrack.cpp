...
void DeepTrack::feed_new_camera(const CameraData &message) {
...
void DeepTrack::feed_monocular(const CameraData &message, size_t msg_id) {
...
void DeepTrack::feed_stereo(const CameraData &message, size_t msg_id_left, size_t msg_id_right) {
...
void DeepTrack::perform_detection_monocular(const std::vector<cv::Mat> &img0pyr, const cv::Mat &mask0, std::vector<cv::KeyPoint> &pts0,
...
void DeepTrack::perform_detection_stereo(const std::vector<cv::Mat> &img0pyr, const std::vector<cv::Mat> &img1pyr, const cv::Mat &mask0,
...
void DeepTrack::perform_matching(const std::vector<cv::Mat> &img0pyr, const std::vector<cv::Mat> &img1pyr, std::vector<cv::KeyPoint> &kpts0,
